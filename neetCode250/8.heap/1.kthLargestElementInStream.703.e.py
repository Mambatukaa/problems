...
int add(int val) Adds a new test score val to the stream and returns the element repre(9); // return 8
...
-104 <= nums[i] <= 104
-104 <= val <= 104
At most 104 calls will be made to add.senting the kth largest element in the pool of test scores so far.
