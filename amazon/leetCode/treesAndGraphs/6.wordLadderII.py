  ...
  while q:
    ...
    for i in range(len(curr)):
      ...
      for combination in string.ascii_lowercase:
        ...
        if neighbor in wordListSet and neighbor not in currSeq:

          # NOTE transformation completed
          if neighbor == endWord:
            currSeq.append(endWord)
            n = len(currSeq)
          ...
          q.append([neighbor, currSeq.copy()])
...
print("res:", wordLadderII(beginWord, endWord, wordList))
