...
At timestamp 10, id1 and id0 are mentioned. mentions =d0 is still offline, they will not be mentioned. mentions = [0,1]
...
It is guaranteed that the user id referenced in the OFFLINE event is online at the time the event occurs. [1,1]
...
At timestamp 12, "HERE" is mentioned. Because i
